/* Tollerud DS — Docs primitives: layout + demo + copy + tokens. → window */
...
Object.assign(window, {
  highlight, CopyButton, Demo, CodeSnippet, PageHeader, Section, SubHead,
  Swatch, TokenTable, ToastProvider, useToast,
